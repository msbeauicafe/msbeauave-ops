...
export const STOCK = ['admin', 'warehouse', 'supervisor'];
export const TILL = ['admin', 'cashier', 'supervisor'];
export const STAFF = ['admin', 'warehouse', 'cashier', 'supervisor'];
...
export const CLOCKDEV = ['admin', 'warehouse', 'cashier', 'supervisor', 'timekeeper'];

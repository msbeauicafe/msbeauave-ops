...
// The order desk: an owner inside Customer order and nothing anywhere else.
...
export const PERSON = ['admin', 'employee'];
...
export const OWN_RECORD = ['admin', 'employee', 'observer'];

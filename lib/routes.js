...
// ---------------------------------------------------------------------------
on('GET', '/api/payroll', ['admin', 'office'], async ({ db, res, query }) => {
...
on('POST', '/api/payroll', ['admin', 'office'], async ({ db, res, body }) => {
...
on('PUT', '/api/payroll-lines/:id', ['admin', 'office'], async ({ db, res, params, body }) => {
  await db.query('select save_payroll_line($1,$2::jsonb)',
    [Number(params.id), JSON.stringify(body || {})]);
  ok(res, { saved: true });
});

on('POST', '/api/payroll/:id/close', ADMIN, async ({ db, res, params }) => {
  await db.query('select close_payroll($1)', [Number(params.id)]);
  ok(res, { closed: true });
});

on('POST', '/api/payroll/:id/reopen', ADMIN, async ({ db, res, params }) => {
...
on('GET', '/api/payslip-mailbox', ['admin', 'office'], async ({ res }) => {
  ok(res, mailFrom());
});

on('POST', '/api/payroll/:id/email', ['admin', 'office'],
...
on('DELETE', '/api/payroll/:id', ADMIN, async ({ db, res, params }) => {
  try {
...
// ---------------------------------------------------------------------------
on('GET', '/api/advances', ['admin', 'office'], async ({ db, res, query }) => {
...
on('POST', '/api/advances', ['admin', 'office'], async ({ db, res, body }) => {
...
on('POST', '/api/advances/:id/take', ['admin', 'office'], async ({ db, res, params, body }) => {
...
on('DELETE', '/api/advance-payments/:id', ['admin', 'office'], async ({ db, res, params }) => {
...
on('POST', '/api/team/:id/email', ['admin', 'office'], async ({ db, res, params, body }) => {
  await db.query('select set_employee_email($1,$2)', [Number(params.id), body.email || '']);
  ok(res, { saved: true });
});

on('POST', '/api/team/:id/pay', ['admin', 'office'], async ({ db, res, params, body }) => {

...
on('POST', '/api/invoices/:id/payments', ADMIN, async ({ db, res, params, body }) => {
...
on('POST', '/api/orders/:id/dropship', ['admin', 'office'], async ({ db, res, params, body }) => {
  try {
...
on('GET', '/api/resellers/:id/payments', ADMIN, async ({ db, res, params, query }) => {
...
on('POST', '/api/orders/:id/invoice', ['admin', 'office'], async ({ db, res, params, body }) => {
  const lines = (body.lines || [])
...
on('POST', '/api/orders/:id/descriptions', ['admin', 'office'], async ({ db, res, params, body }) => {
  const lines = (body.lines || [])
...
on('POST', '/api/orders/:id/numbers', ['admin', 'office'], async ({ db, res, params, body }) => {
...
// carries on from.
on('POST', '/api/orders/:id/invoice-no', ['admin', 'office'], async ({ db, res, params, body }) => {
  try {
...
on('POST', '/api/orders/:id/lines', ['admin', 'office'], async ({ db, res, params, body }) => {
  const lines = (body.lines || [])
